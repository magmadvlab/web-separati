...
function StripePaymentFormInner({ ordineId, totale, onSuccess, onError }: StripePaymentFormProps) {
...
export function StripePaymentForm({ ordineId, totale, onSuccess, onError }: StripePaymentFormProps) {
