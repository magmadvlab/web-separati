...
import { FileText, Calendar, User, Eye, Plus, CheckCircle2, AlertCircle } from "lucide-react";
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-2">Gestisci i referti degli esami</p>
          </div>
              ...
              <div className="text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-400 mt-1">
                    Crea un referto per una prenotazione completata
                  </p>
                </div>
                <Link href="/laboratorio/prenotazioni">
                  <Button className="hover-lift">
