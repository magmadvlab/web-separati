...
export default function AderenzaPage() {
  ...
  return (
    <div className="container mx-auto py-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold">Reminder Farmaci & Aderenza</h1>
        <p className="text-gray-600 mt-2">
          Conferma le assunzioni di oggi e monitora la tua aderenza alle terapie
        </p>
      </div>

      <div className="space-y-6">
        {/* Widget principale: assunzioni di oggi con confirm/skip */}
        <MedicationReminders />

        {/* Report aderenza storico */}
        {/* Filtri */}
        <Card>
